    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\Admin\Desktop\Project\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/Admin/Desktop/Project/Face-Recognition-Attendance-System-main/Attendance/Automatic Attendance' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\Admin\Desktop\Project\Face-Recognition-Attendance-System-main\Attendance\Automatic Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'Samarth Jadhav':
            if password == 'Samarth@123':
                ...
                cs = 'C:/Users/Admin/Desktop/Project/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
lbl = tk.Label(window, text="Enter Enrollment : ", width=20, height=2,
               fg="black", bg="yellow", font=('times', 15, 'bold'))
